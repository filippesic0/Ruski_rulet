namespace Ruski_rulet
{
	partial class Ruski_rulet
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Ruski_rulet));
			this.novac6 = new System.Windows.Forms.Label();
			this.ime6 = new System.Windows.Forms.Label();
			this.novac5 = new System.Windows.Forms.Label();
			this.ime5 = new System.Windows.Forms.Label();
			this.novac4 = new System.Windows.Forms.Label();
			this.ime4 = new System.Windows.Forms.Label();
			this.novac3 = new System.Windows.Forms.Label();
			this.ime3 = new System.Windows.Forms.Label();
			this.novac2 = new System.Windows.Forms.Label();
			this.ime2 = new System.Windows.Forms.Label();
			this.novac1 = new System.Windows.Forms.Label();
			this.ime1 = new System.Windows.Forms.Label();
			this.vreme = new System.Windows.Forms.TextBox();
			this.netacno = new System.Windows.Forms.Button();
			this.tacno = new System.Windows.Forms.Button();
			this.pitanje = new System.Windows.Forms.TextBox();
			this.rucica = new System.Windows.Forms.VScrollBar();
			this.izazovi6 = new System.Windows.Forms.Button();
			this.izazovi5 = new System.Windows.Forms.Button();
			this.izazovi4 = new System.Windows.Forms.Button();
			this.izazovi3 = new System.Windows.Forms.Button();
			this.izazovi2 = new System.Windows.Forms.Button();
			this.izazovi1 = new System.Windows.Forms.Button();
			this.biranje_izazivaca = new System.Windows.Forms.Timer(this.components);
			this.spica = new System.Windows.Forms.Timer(this.components);
			this.kraj_runde = new System.Windows.Forms.Timer(this.components);
			this.runda_5 = new System.Windows.Forms.Timer(this.components);
			this.odgovaranje = new System.Windows.Forms.Timer(this.components);
			this.rulet = new System.Windows.Forms.Timer(this.components);
			this.kraj = new System.Windows.Forms.Timer(this.components);
			this.cekanje = new System.Windows.Forms.Timer(this.components);
			this.otkljucavanje_polja = new System.Windows.Forms.Timer(this.components);
			...
			this.netacno.Visible = false;
			this.netacno.Click += new System.EventHandler(this.netacno_Click);
			// 
			// tacno
			// 
			...
			this.tacno.Visible = false;
			this.tacno.Click += new System.EventHandler(this.tacno_Click);
			// 
			// pitanje
			// 
			...
			this.izazovi6.Visible = false;
			this.izazovi6.Click += new System.EventHandler(this.izazovi6_Click);
			// 
			// izazovi5
			// 
			...
			this.izazovi5.Visible = false;
			this.izazovi5.Click += new System.EventHandler(this.izazovi5_Click);
			// 
			// izazovi4
			// 
			...
			this.izazovi4.Visible = false;
			this.izazovi4.Click += new System.EventHandler(this.izazovi4_Click);
			// 
			// izazovi3
			// 
			...
			this.izazovi3.Visible = false;
			this.izazovi3.Click += new System.EventHandler(this.izazovi3_Click);
			// 
			// izazovi2
			// 
			...
			this.izazovi2.Visible = false;
			this.izazovi2.Click += new System.EventHandler(this.izazovi2_Click);
			// 
			// izazovi1
			// 
			...
			this.izazovi1.Visible = false;
			this.izazovi1.Click += new System.EventHandler(this.izazovi1_Click);
			// 
			// biranje_izazivaca
			// 
			this.biranje_izazivaca.Tick += new System.EventHandler(this.biranje_izazivaca_Tick);
			// 
			// spica
			// 
			this.spica.Tick += new System.EventHandler(this.spica_Tick);
			// 
			// kraj_runde
			// 
			this.kraj_runde.Tick += new System.EventHandler(this.kraj_runde_Tick);
			// 
			// runda_5
			// 
			this.runda_5.Interval = 1000;
			this.runda_5.Tick += new System.EventHandler(this.runda_5_Tick);
			// 
			// odgovaranje
			// 
			this.odgovaranje.Interval = 1000;
			this.odgovaranje.Tick += new System.EventHandler(this.odgovaranje_Tick);
			// 
			// rulet
			// 
			this.rulet.Tick += new System.EventHandler(this.rulet_Tick);
			// 
			// cekanje
			// 
			this.cekanje.Interval = 1000;
			this.cekanje.Tick += new System.EventHandler(this.cekanje_Tick);
			// 
			// otkljucavanje_polja
			// 
			this.otkljucavanje_polja.Tick += new System.EventHandler(this.otkljucavanje_polja_Tick);
			// 
			// player
			// 
			...
			this.Controls.Add(this.novac5);
			this.Controls.Add(this.ime5);
			this.Controls.Add(this.novac4);
			this.Controls.Add(this.ime4);
			this.Controls.Add(this.novac3);
			this.Controls.Add(this.ime3);
			this.Controls.Add(this.novac2);
			this.Controls.Add(this.ime2);
			this.Controls.Add(this.novac1);
			this.Controls.Add(this.ime1);
			this.Controls.Add(this.vreme);
			this.Controls.Add(this.netacno);
			this.Controls.Add(this.tacno);
			this.Controls.Add(this.pitanje);
			this.Controls.Add(this.rucica);
			this.Controls.Add(this.izazovi6);
			this.Controls.Add(this.izazovi5);
			this.Controls.Add(this.izazovi4);
		...
		private System.Windows.Forms.Label novac6;
		private System.Windows.Forms.Label ime6;
		private System.Windows.Forms.Label novac5;
		private System.Windows.Forms.Label ime5;
		private System.Windows.Forms.Label novac4;
		private System.Windows.Forms.Label ime4;
		private System.Windows.Forms.Label novac3;
		private System.Windows.Forms.Label ime3;
		private System.Windows.Forms.Label novac2;
		private System.Windows.Forms.Label ime2;
		private System.Windows.Forms.Label novac1;
		private System.Windows.Forms.Label ime1;
		private System.Windows.Forms.TextBox vreme;
		private System.Windows.Forms.Button netacno;
		private System.Windows.Forms.Button tacno;
		private System.Windows.Forms.TextBox pitanje;
		private System.Windows.Forms.VScrollBar rucica;
		private System.Windows.Forms.Button izazovi6;
		private System.Windows.Forms.Button izazovi5;
		private System.Windows.Forms.Button izazovi4;
		private System.Windows.Forms.Button izazovi3;
		private System.Windows.Forms.Button izazovi2;
		private System.Windows.Forms.Button izazovi1;
		private System.Windows.Forms.Timer biranje_izazivaca;
		private System.Windows.Forms.Timer spica;
		private System.Windows.Forms.Timer kraj_runde;
		private System.Windows.Forms.Timer runda_5;
		private System.Windows.Forms.Timer odgovaranje;
		private System.Windows.Forms.Timer rulet;
		private System.Windows.Forms.Timer kraj;
		private System.Windows.Forms.Timer cekanje;
		private System.Windows.Forms.Timer otkljucavanje_polja;
